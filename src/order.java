...
public class order {
        ...
        String choice = scanner.nextLine();
    {
...

        {
            ...
            System.out.println(DrinkPrice+FirstPrice+SecondPrice+salatPrice+dessertPrice);
        }
    }
